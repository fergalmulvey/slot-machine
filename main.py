...
def spin(balance):
    ...
    while True: 
        ...
        if total_bet > balance:
            print(f"Bet exceeds balance. Your balance is €{balance}.")
        else:
            break

    print(f"You are betting €{bet} on {lines} lines. Total amount to bet is €{total_bet} ")
